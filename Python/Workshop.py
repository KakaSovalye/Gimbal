...
while True:
    ...
    cv2.line(imaj2,((eKam // 2 + 60, bKam // 2 + 12)),((eKam // 2 + 60, bKam // 2 + 35)),(255,0,0),3)
    cv2.line(imaj2, ((eKam // 2 + 60, bKam // 2 + 42)), ((eKam // 2 + 60, bKam // 2 + 62)), (255, 0, 0), 3)
    cv2.line(imaj2, ((eKam // 2 + 30, bKam // 2 + 40)), ((eKam // 2 + 40, bKam // 2 + 40)), (255, 0, 0), 3)
    cv2.line(imaj2, ((eKam // 2 + 80, bKam // 2 + 40)), ((eKam // 2 + 90, bKam // 2 + 40)), (255, 0, 0), 3)
